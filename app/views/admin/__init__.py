...
from app.views.panel.endpoints import category as panel_category_router
...
app.include_router(panel_category_router.router, prefix="/panel/category", tags=["Category"])
